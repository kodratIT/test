...
<head>
  ...
  <title>Verifikasi Laporan Berkala</title>
  <!--     Fonts and icons     -->
                            ...
                            <div class="w-full max-w-full px-3">
                                ...
                                <div id="page0">
                                    ...
                                    <div class="mt-6 flex justify-between">
                                        <!-- Tombol Keluar -->
                                        <a href="{{ route('laporan.kabid.index') }}"
                        ...
                        <div id="page3" class="hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border border-gray-200 rounded shadow-sm overflow-hidden p-4">
                                ...
                                <div class="bg-white rounded shadow p-4 space-y-4 border-2 border-gray-300">
                                    ...
                                    <div class="pt-2 mt-6">
                                        <button onclick="tampilkanPopup10()" class="bg-green-600 hover:bg-green-700 text-white font-semibold px-4 py-2 rounded w-full">
                                            Simpan Evaluasi
                                        </button>
                                    </div>
                                ...
                                <script>
                                    ...
                                    function verifikasiDokumen() {
                                        ...
                                        Swal.fire({
                                            ...
                                            window.location.href = "/verifikasi/selesai"; // ganti URL ini sesuai kebutuhan
                                        });
                                    }
                                </script>
 ...
 -->
                                ...
                                <div id="modal-evaluator" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
                                    <div class="bg-white dark:bg-slate-800 rounded-xl p-6 w-full max-w-2xl shadow-lg relative max-h-[90vh] flex flex-col">
                                        ...
                                        <div class="space-y-2 overflow-y-auto pr-2" style="max-height: 60vh;">
                                            ...
                                            <label class="flex items-center p-2 border rounded-lg cursor-pointer hover:bg-gray-50">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="text-xs text-gray-500">
                                                        NIP: {{ $evaluator->identitasTimAdmin->nip ?? '-' }}
                                                    </div>
                                                </div>
                                            </label>
                                                @endforeach
                                            @else
                                                <div class="text-center py-8">
                                                    <p class="text-gray-500">Tidak ada evaluator yang tersedia</p>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <script>
                                    ...
                                    function kirimKeEvaluator() {
                                        const selected = document.querySelector('input[name="evaluator_id"]:checked');
                                        if (!selected) {
                                            Swal.fire({
                                                icon: 'warning',
                                                title: 'Evaluator Belum Dipilih',
                                                text: 'Silakan pilih salah satu evaluator.',
                                            });
                                            return;
                                        }

                                        const evaluatorID = selected.value;
                                        const pengajuanID = "{{ $pengajuan->id }}"; // pastikan variable ini dikirim dari controller

                                        fetch(`/pengajuan/${pengajuanID}/kirim-evaluator`, {
                                                method: "POST",
                                                headers: {
                                            ...
                                            .then(data => {
                                                if (data.success) {
                                                    Swal.fire({
                                                        ...
                                                        text: 'Pengajuan berhasil dikirim ke evaluator.'
                                            ...
                                            .catch(err => {
                                                ...
                                                Swal.fire({
                                                    icon: 'error',
                                                    title: 'Gagal',
                                                    text: 'Terjadi kesalahan saat mengirim ke evaluator.'
                                                });
                                            });
                                    }
                                </script>
