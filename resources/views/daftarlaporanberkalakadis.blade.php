                      ...
                      @elseif($pengajuan->status === 'disetujui kadis')
                        @if($pengajuan->lembar_pengesahan_pdf)
                          ...
                          <div class="flex flex-col gap-1 items-center">
                            <a href="{{route('dokumen.pdf.preview', $pengajuan->id)}}" target="_blank" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600 bg-blue-300  transition-colors duration-200">
                             
                              Lihat
                            </a>
                            <a href="{{ route('dokumen.pdf.download', $pengajuan->id) }}" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600 transition-colors duration-200">
