                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border border-gray-200 rounded shadow-sm overflow-hidden p-4">
                                        ...
                                        <div class="bg-white rounded shadow p-4 space-y-4 border-2 border-gray-300">
                                            ...
                                            <textarea
                                                ...
                                                rows="8"
                                                class="w-full p-2 border rounded text-sm bg-gray-100 text-red-500"
                                            ...
                                            <select
                                                ...
                                                class="w-full border p-2 rounded text-sm bg-white text-red-500"
                                                disabled>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border border-gray-200 rounded shadow-sm overflow-hidden p-4">
                                        ...
                                        <div class="bg-white rounded shadow p-4 space-y-4 border-2 border-gray-300">
                                            ...
                                            <textarea
                                                ...
                                                rows="8"
                                                class="w-full p-2 border rounded text-sm bg-gray-100 text-red-500"
                                                disabled>Nomor Tidak Sesuai</textarea>
                            ...
                            <div class="w-full flex justify-between items-center py-4">
                                ...
                                <div id="modal-kirim-hasil" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
                                    <div class="bg-white dark:bg-slate-800 rounded-lg p-6 w-full max-w-sm shadow-lg relative">
                                        ...
                                        <!-- Tombol 2: Perbaikan (Aktif) -->
                                        <button onclick="openModal()" class="w-full text-left px-4 py-2 mb-3 bg-red-600 text-white rounded hover:bg-red-700 transition">
                                            Perbaikan
                                        </button>

                                        <!-- Tombol 3: Verifikasi (Nonaktif) -->
                                        <button disabled class="w-full text-left px-4 py-2 mb-3 bg-blue-300 text-white rounded cursor-not-allowed opacity-60">
                                            Verifikasi
                                        </button>
