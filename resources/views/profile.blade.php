  ...
  <aside
    ...
    <div class="items-center block h-auto w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
            href="../pages/pengajuansurat.html">
            <div
              class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
    ...
    <nav
      ...
      <div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
        <nav>
          ...
          <h6 class="mb-2 ml-2 font-bold text-white capitalize dark:text-white">Profil Perusahaan</h6>
        </nav>
        ...
        <div class="flex flex-wrap -mx-3">
          <div class="flex-none w-auto max-w-full px-3">
            <div
              ...
              <img src="../assets/img/profil1.jpeg" alt="profile_image" class="w-full shadow-2xl rounded-xl" />
            </div>
          </div>
          ...
          <div
            ...
            <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
              <div class="flex items-center">
                ...
                <button type="button"
                  class="inline-block px-8 py-2 mb-4 ml-auto font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-blue-500 border-0 rounded-lg shadow-md cursor-pointer text-xs tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">Pengaturan</button>
              </div>
            </div>
            <form action="/submit" method="POST" class="max-w-md mx-auto p-4 bg-white rounded-xl shadow-md dark:bg-slate-800">
            <div class="flex-auto p-6">
              <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-base font-bold">DATA AKUN</p>
              <div class="flex flex-wrap -mx-3">
            ...
            <div class="flex-auto p-6">
              <p  class="leading-normal uppercase dark:text-white dark:opacity-60 text-base font-bold">PROFIL PERUSAHAAN
              </p>
              <div class="flex flex-wrap -mx-3">
                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                  <div class="mb-4">
                    <label for="namabadanusaha"
                      class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Nama (Badan
                      Usaha / Instansi /Perseorangan)</label>
                ...
                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                  <div class="mb-4">
                    <label for="email"
                      class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Jenis Bidang
                      Usaha</label>
                ...
                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                  <div class="mb-4">
                    <label for="first name"
                      class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Penanggung
                      Jawab</label>
              ...
              <hr
                class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent " />
              <p onclick="document.getElementById('alamatForm').classList.toggle('hidden')" class="leading-normal uppercase dark:text-white dark:opacity-60 text-base font-bold">ALAMAT PERUSAHAAN  <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" stroke-width="2"
              viewBox="0 0 24 24">
              ...
              <div class="flex flex-wrap -mx-3">
                <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0">
                  <div id="alamatForm" class="hidden mt-4">
                  <div class="mb-4">
                    <label for="address"
                      class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Alamat (Badan
                      Usaha/Instansi/Perseorangan) </label>
                  ...
                  <div class="mb-4">
                    <label for="address"
                      ...
                      Pembangkit </label>
                    <input type="text" name="lokasipembangkit" id="lokasipembangkit"  required
                      class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                  </div>
                  <div class="mb-4">
                    <label for="address"
                ...
                <button type="submit" class="mt-4 px-5 py-3 text-xs font-bold leading-tight dark:text-white text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-all">
                    Simpan
                  </button>
                </form>
