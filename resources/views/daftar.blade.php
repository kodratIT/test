          ...
          <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
            <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
              ...
              <div class="flex-auto p-6">
                <form role="form text-left" action="{{ route('daftar') }}" method="POST" autocomplete="off">
                @csrf
                ...
                <div class="mb-4">
                  <input type="text" name="name" autocomplete="off"
                    ...
                    placeholder="Nama" aria-label="Nama" aria-describedby="nama-addon" required />
                </div>
                ...
                <div class="mb-4">
                  <input type="password" name="password" autocomplete="new-password"
                    class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                    placeholder="Kata Sandi" aria-label="Kata Sandi" aria-describedby="password-addon" required />
                </div>
                ...
                <div class="min-h-6 pl-7 mb-0.5 block">
                  ...
                  <label class="mb-2 ml-1 font-normal cursor-pointer text-sm text-slate-500" for="flexCheckDefault">
                    Saya menyetujui <a href="javascript:;" class="font-normal text-slate-500">terhadap data yang saya input</a>
                  </label>
                </div>
                ...
                <p class="mt-4 mb-0 leading-normal text-center text-sm">
                  Anda sudah ada akun? <a href="{{ route('masuk') }}" class="font-bold text-slate-700">Masuk</a>
                </p>
              </form>
              </div>
            </div>
