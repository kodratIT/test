        ...
        <table class="min-w-full table-auto">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-blue-50">
              ...
              <td class="py-3 px-4 text-xs font-medium">{{ $evaluator->name }}</td>
              <td class="py-3 px-4 text-xs text-center">
                <span class="inline-block px-2 py-1 text-xs rounded">{{$evaluator->identitasTimAdmin->pangkat ?? '_' }}</span>
              </td>
              <td class="py-3 px-4 text-xs text-center">{{ $evaluator->email }}</td>
              <td class="py-3 px-4 text-xs font-medium text-center">Evaluator</td>
              <td class="py-3 px-4 text-center">
                <form action="{{ route('evaluator.destroy', $evaluator->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('DELETE')
                  <button type="submit"
          ...
          <tbody class="divide-y divide-gray-200">
            <div class="flex justify-between items-center mb-4">
              ...
              <button onclick="openTambahEvaluatorModal()"
            ...
            <div id="modalTambahEvaluator" class="fixed inset-0 hidden items-center justify-center bg-black bg-opacity-50 z-50">
              <div class="bg-white w-full max-w-md p-6 rounded-lg shadow-lg">
                ...
                <form action="{{ route('evaluator.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3">
            ...
            <div id="popup-konfirmasi-hapus-evaluator1" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">
              <div class="bg-white rounded-lg p-6 w-80 shadow-lg text-center">
                ...
                <div class="flex justify-center gap-4">
                  <button onclick="hapusEvaluator()" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded">Hapus</button>
