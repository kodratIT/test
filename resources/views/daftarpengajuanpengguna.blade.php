        ...
        <div class="flex-none w-full max-w-full px-3">
          <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl">
            <div class="p-6 pb-0 mb-0 border-b border-b-transparent rounded-t-2xl">
              <h6 class="dark:text-white mb-6 text-black text-xl font-semibold">DAFTAR PERMOHOMAN SURAT KETERANGAN</h6>
            </div>
            <div class="flex-auto pt-0 pb-2 overflow-x-auto">
              <table class="min-w-full text-sm text-left text-slate-500 dark:text-slate-200">
                <thead class="uppercase text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-700">
                  <tr>
                    <th class="px-4 py-3 text-base text-slate-900 font-semibold whitespace-nowrap">No Laporan</th>
                    <th class="px-4 py-3 text-base text-slate-900 font-semibold text-center whitespace-nowrap">Tanggal Laporan</th>
                    <th class="px-4 py-3 text-base text-slate-900 font-semibold text-center whitespace-nowrap">Keterangan / Catatan Perbaikan</th>
                    <th class="px-4 py-3 text-base text-slate-900 font-semibold text-center whitespace-nowrap">Status</th>
                    <th class="px-4 py-3 text-base text-slate-900 font-semibold text-center whitespace-nowrap">Aksi</th>
                  </tr>
                </thead>
